...
/**
 * Get top border size in columns.
 * @param b - Border style
 * @returns Width of top border elements
 */
...
/**
 * Get right border size in columns.
 * @param b - Border style
 * @returns Width of right border elements
 */
...
/**
 * Get bottom border size in columns.
 * @param b - Border style
 * @returns Width of bottom border elements
 */
...
/**
 * Get left border size in columns.
 * @param b - Border style
 * @returns Width of left border elements
 */
...
type BorderStyleKey = keyof typeof borders
